    ...
    IQuoteV1
{
    ...
    CountersUpgradeable.Counter internal _quoteIds;
        ...
        returns (address paymentAssetAddress, uint256 totalPayment)
    {
        ...
        return (paymentAsset.assetAddress, totalPayment);
    }
    ...
    function _isNativeCoin(address assetAddress) internal pure returns (bool) {
